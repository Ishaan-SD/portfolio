        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 min-h-[280px]">
          {filteredSkills.map((skill, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`group relative p-5 rounded-2xl glassmorphism border border-card-border shadow-sm flex flex-col justify-between transition-all duration-300 hover:-translate-y-1 hover:shadow-md h-full ${skill.glowClass}`}
                >
                  {/* Visual Icon Header */}
