      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <ScrollReveal variant="slide-up" duration={700}>
          <div className="flex flex-col items-center text-center gap-4 mb-16">
            <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-brand-500/10 border border-brand-500/20 text-xs font-bold tracking-wider text-brand-500 uppercase">
              ...
              <TextScramble text="Selected Portfolios" />
            </div>
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-foreground">
              <TextScramble text="Featured Creations" />
            </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8 min-h-[350px]">
          {filteredProjects.map((project, index) => (
            ...
            >
              <article
                className="group relative flex flex-col justify-between rounded-3xl glassmorphism border border-card-border overflow-hidden shadow-lg transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl hover:border-brand-500/30 h-full"
              >
